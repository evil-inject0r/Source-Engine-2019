...
set DIRECTX_SDK_BIN_DIR=devtools\bin\dx9_00\%platform%
...
:dx_sdk_dx9_30
			...
			set DIRECTX_SDK_BIN_DIR=devtools\bin\dx9_30\%platform%
			goto dx_sdk_end
:dx_sdk_dx10
			set DIRECTX_SDK_VER=pc10.00
			set DIRECTX_SDK_BIN_DIR=devtools\bin\dx10_40\%platform%
			goto dx_sdk_end
:dx_sdk_end
