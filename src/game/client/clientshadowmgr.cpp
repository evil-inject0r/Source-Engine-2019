...
void CClientShadowMgr::ComputeShadowTextures( const CViewSetup &view, int leafCount, LeafIndex_t* pLeafList )
{
	...
	if ( m_bThreaded && g_pThreadPool->NumIdleThreads() )
	{
		...
		ParallelProcess("SetupBonesOnBaseAnimating", s_NPCShadowBoneSetups.Base(), s_NPCShadowBoneSetups.Count(), &SetupBonesOnBaseAnimating );
		ParallelProcess("SetupBonesOnBaseAnimating", s_NonNPCShadowBoneSetups.Base(), s_NonNPCShadowBoneSetups.Count(), &SetupBonesOnBaseAnimating );
